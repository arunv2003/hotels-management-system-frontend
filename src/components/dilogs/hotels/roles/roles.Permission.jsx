...
const MODULES = [
  ...
  { id: "rooms", label: "Rooms", actions: ["add", "view", "edit", "delete", "global_view"] },
  { id: "bookings", label: "Bookings", actions: ["add", "view", "edit", "delete", "global_view"] },
  { id: "guests", label: "Guests", actions: ["add", "view", "edit", "delete", "global_view"] },
  { id: "pos", label: "Restaurant / POS", actions: ["add", "view", "edit", "delete", "global_view"] },
  { id: "housekeeping", label: "Housekeeping", actions: ["add", "view", "edit", "delete", "global_view"] },
  { id: "inventory", label: "Inventory", actions: ["add", "view", "edit", "delete", "global_view"] },
  { id: "staff", label: "Staff Management", actions: ["add", "view", "edit", "delete", "global_view"] },
  { id: "payroll", label: "Payroll", actions: ["add", "view", "edit", "delete", "global_view"] },
  { id: "attendance", label: "Attendance", actions: ["add", "view", "edit", "delete", "global_view"] },
  { id: "reports", label: "Reports & Analytics", actions: ["view", "global_view"] },
  { id: "settings", label: "Hotel Settings", actions: ["view", "edit", "global_view"] },
  { id: "tasks", label: "Tasks", actions: ["add", "view", "edit", "delete", "global_view"] },
...
export default function AddHotelRoles({ isOpen, onClose, onSave }) {
  ...
  const getModulePermissionCount = (module) => {
    ...
    const enabledActions = availableActions.filter((action) =>
      has(module.id, action)
    );
