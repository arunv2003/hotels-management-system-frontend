...
export const StatCard = ({ title, value, icon: Icon, trend, color = 'indigo' }) => {
    return (<motion.div whileHover={{ y: -4 }} className="glass-card p-6 rounded-lg flex flex-col gap-4 group">
      <div className="flex items-center justify-between">
        <div className={cn("p-2.5 rounded-md transition-transform group-hover:scale-110", colorMap[color])}>
