...
export default function PublicFooter() {
  return (
    <footer className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 border-t border-slate-100 dark:border-slate-900 bg-slate-50/50 dark:bg-slate-950/50 transition-colors">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-12 sm:mb-16">
        ...
        <div>
          <h4 className="font-bold text-slate-900 dark:text-white mb-4 sm:mb-6 uppercase text-xs tracking-wider">
            Quick Navigation
          </h4>
          <ul className="space-y-3 text-sm">
            ...
            <li>
              <Link href="/about-us" className="text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                About Our Platform
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/login" className="text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                Portal Login
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li>
              <Link href="/privacy-policy" className="text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                Privacy Policy
              </Link>
            </li>
            <li>
              <Link href="/terms-and-conditions" className="text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                Terms & Conditions
              </Link>
            </li>
            <li>
              <Link href="/customer-support" className="text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                Customer Support & Helpdesk
              </Link>
            </li>
            <li>
              <Link href="/contact-us" className="text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                Contact Us
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
            <li className="flex items-center gap-2.5">
              ...
              <span className="truncate">support@vedantatech.com</span>
            </li>
            <li className="flex items-center gap-2.5">
